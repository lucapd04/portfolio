  ...
  return (
    <>
      ...
      <div className="flex flex-col items-start justify-center h-screen relative">
        <Spline className="absolute inset-0 z-0" scene="https://prod.spline.design/qQ9x8xBmlGO8INMU/scene.splinecode" /> {/*banner changed again*/}
        <div className="z-10 px-5 text-center md:ml-[5%] text-white md:text-left -mt-[12%] drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)]">
          <h1 className="rubik-headline font-bold text-7xl mb-8">Welcome to my journey</h1>
